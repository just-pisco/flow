...
<body class="bg-gray-50 text-gray-900">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-6 pt-10 md:pt-12">
                ...
                <div class="relative w-full md:w-64">
                    <input type="text" id="taskSearch" name="search_tasks_unique_v2" autocomplete="off"
                        ...
                        onkeyup="searchTasks()"
                        class="w-full bg-white border border-slate-200 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none">
                </div>
            </div>
    ...
    <div id="editTaskModal" class="fixed inset-0 z-50 flex items-center justify-center hidden"
        ...
        <div class="bg-white rounded-xl shadow-2xl w-[95%] md:w-[90%] max-w-6xl relative z-10 transform transition-all scale-95 opacity-0 flex flex-col max-h-[90vh]"
            id="editTaskContent">
            ...
            <div class="p-6 overflow-y-auto flex-1">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="editTaskDesc" rows="4"
                        ...
                        onfocus="this.style.minHeight = '400px'; setTimeout(() => this.scrollIntoView({ behavior: 'smooth', block: 'center' }), 50)"
