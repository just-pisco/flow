<?php if (!defined('PROJECT_DETAILS_MODAL_INCLUDED')):
    define('PROJECT_DETAILS_MODAL_INCLUDED', true); ?>
    ...
    <div id="projectDetailsModal" class="fixed inset-0 z-50 flex items-center justify-center hidden"
        ...
        <div class="bg-white rounded-xl shadow-2xl w-[95%] md:w-[90%] max-w-6xl relative z-10 transform transition-all scale-95 opacity-0 flex flex-col max-h-[90vh] overflow-hidden"
                ...
                <div id="tab-info" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="detailProjectDesc" rows="6"
                            ...
                            onfocus="this.style.minHeight = '500px'; setTimeout(() => this.scrollIntoView({ behavior: 'smooth', block: 'center' }), 50)"
